...
public class BusSearchService {
    ...
    public List<BusSearchDTO> getChilwonSchedules(String departureStop, String arrivalStop) {
     ...
     * 마산 노선 버스 시간표 조회
     */
    public List<BusSearchDTO> getMasanSchedules(String departureStop, String arrivalStop) {
